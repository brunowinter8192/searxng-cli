...
Bead: `searxng-f3i` | Predecessor investigation: `scholar_concurrent_block/20260508.md`
...
- Production result: 100% EMPTY_BLOCK in every default or pdf-mode query (triggers a+b both active — see `scholar_concurrent_block/20260508.md` Evidence Table)
...
| Source | Relevance |
|---|---|
| `decisions/OldThemes/scholar_concurrent_block/20260508.md` | Root-cause investigation, 2×2 architecture × Google matrix, Evidence Table |
