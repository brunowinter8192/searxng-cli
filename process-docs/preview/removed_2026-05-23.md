...
Preview-fetch (preview.py + og/meta integration) wurde im Rahmen der Migration auf die Two-Call-Drilldown-Architektur gelöscht. Engine-eigene Snippets sind jetzt die einzige Snippet-Quelle. Rationale: decisions/OldThemes/pooling/10_eyeball_engine_provenance.md.
