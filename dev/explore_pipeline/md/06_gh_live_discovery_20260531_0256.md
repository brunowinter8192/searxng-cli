...
| Metric | Value |
|--------|-------|
| Found (normalized union) | 316 |
| FPT sidebar (raw) | 256 |
| GHEC sidebar (raw) | 285 → 36 net additions after normalize |
| GHES sidebar (raw) | 1336 |
| Matched gold | 305 / 305 |
| Recall % | 100.0% |
| Missing | 0 |
| Noise | 11 |
| Wall-clock | 1.6s |
...
Generic move: deprecated pages disappear from newer versions but persist in older.
Check every version listed in allVersions, union normalized results.
GHES versions to check: ['enterprise-server@3.21', 'enterprise-server@3.20', 'enterprise-server@3.19', 'enterprise-server@3.18', 'enterprise-server@3.17', 'enterprise-server@3.16']
  enterprise-server@3.21: 235 raw → 235 normalized, 13 net new vs prior
  enterprise-server@3.20: 234 raw → 234 normalized, 2 net new vs prior
  enterprise-server@3.19: 224 raw → 224 normalized, 1 net new vs prior
  enterprise-server@3.18: 217 raw → 217 normalized, 1 net new vs prior
  enterprise-server@3.17: 212 raw → 212 normalized, 1 net new vs prior
  enterprise-server@3.16: 214 raw → 214 normalized, 6 net new vs prior
GHES union: 246 normalized, 24 net new vs FPT+GHEC (1.1s)
...
Union normalized: 316 unique /de/rest/... URLs
  FPT raw: 256
  GHEC raw: 285  →  normalized unique additions: 36
  GHES (all versions) raw: 1336  →  normalized unique additions: 24
...
Noise sample (up to 20):
  ...
  - https://docs.github.com/de/enterprise-server@3.16/rest
  - https://docs.github.com/de/enterprise-server@3.17/rest
  - https://docs.github.com/de/enterprise-server@3.18/rest
  - https://docs.github.com/de/enterprise-server@3.19/rest
  - https://docs.github.com/de/enterprise-server@3.20/rest
