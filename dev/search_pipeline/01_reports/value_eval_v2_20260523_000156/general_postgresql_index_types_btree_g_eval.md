...
**Pool size (filtered+capped):** 48  
**google_count:** 0  
**full_pool:** 239  | **capped_pool:** 48  
**filtered_capped:** 48  
...
1. https://www.postgresql.org/docs/current/indexes-types.html
   Rationale: Official PostgreSQL documentation on Index Types — the canonical primary source for all index types (B-tree, Hash, GiST, SP-GiST, GIN, BRIN), directly authoritative for the query.

2. https://doi.org/10.20944/preprints202511.2170.v1
   Rationale: Preprint 'Indexing in PostgreSQL: Performance Evaluation and Use Cases' — comprehensive performance evaluation of all six native index types with empirical measurements.

3. https://bigdataboutique.com/blog/postgresql-indexes-best-practices
   Rationale: 'PostgreSQL Indexes Best Practices: Choosing the Right Index for Every ...' — comprehensive practical guide covering B-tree, GIN, GiST, BRIN, when-to-use criteria, and production optimization techniques.

4. https://www.iamraghuveer.com/posts/postgresql-indexes-deep-dive/
   Rationale: 'PostgreSQL Indexes Deep Dive: B-Tree, GIN, GiST, and BRIN' — detailed practical guide covering the most common PostgreSQL index types and performance trade-offs.

5. https://www.elysiate.com/blog/best-postgresql-indexes-for-performance
   Rationale: 'Best PostgreSQL Indexes for Performance' — practical guide covering B-tree, GIN, GiST, BRIN, partial, multicolumn, covering, and expression indexes with performance focus.

6. https://dba.stackexchange.com/questions/46685/index-method-for-very-few-updates-and-many-inserts
   Rationale: DBA StackExchange on GIN vs GiST performance — direct performance comparison: 'GIN is faster to search, slower to build/update'. Authoritative community answer with practical guidance.

7. https://elephanttamer.net/?p=9
   Rationale: 'GiST vs GIN index for LIKE searches — a comparison' — specific performance benchmark for trigram indexing: 'always use GIN for trigram indexing'. Practical performance comparison.

8. https://www.semanticscholar.org/paper/Comparative-analysis-of-indexing-strategies-in-load-Zolotukhina/a1bcf6c3ddb11cd3dc7cb9cafbbae31fd2c222f7
   Rationale: Semantic Scholar 'Comparative analysis of indexing strategies in PostgreSQL under various load scenarios' — empirical performance study with recommendations by query type and load conditions.

9. https://stackoverflow.com/questions/40780825/btree-vs-gin-vs-gist-index
   Rationale: SO 'BTREE vs GIN vs GIST index' — community comparison citing PostgreSQL documentation directly; practical answers on choosing between B-tree, GIN, and GiST.

10. https://doi.org/10.64149/j.ijesrt.15.4.22-31
   Rationale: 'A Comparative Experimental Study of Index Performance in MongoDB and PostgreSQL' — empirical performance measurements across PostgreSQL index types and query patterns.
...
10. https://hakibenita.com/postgresql-correlation-brin-multi-minmax
...
6. https://www.iamraghuveer.com/posts/postgresql-indexes-deep-dive/
...
10. https://www.postgresql.org/docs/current/indexes-types.html
...
4. https://bigdataboutique.com/blog/postgresql-indexes-best-practices
5. https://www.iamraghuveer.com/posts/postgresql-indexes-deep-dive/
...
10. https://stackoverflow.com/questions/40780825/btree-vs-gin-vs-gist-index
...
- https://dba.stackexchange.com/questions/46685/index-method-for-very-few-updates-and-many-inserts
- https://elephanttamer.net/?p=9
- https://doi.org/10.64149/j.ijesrt.15.4.22-31
