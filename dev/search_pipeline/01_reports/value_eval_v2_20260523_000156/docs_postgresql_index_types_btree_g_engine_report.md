...
|-------|------:|
| Raw results | 231 |
| Capped (K=google_count) | 40 |
| Oracle pool (capped — no URL filter) | 40 |

## Engine Breakdown

| Engine | URLs | Status | Reason | ms |
|--------|-----:|--------|--------|----|
| crossref | 200 | OK |  | 1906 |
| duckduckgo | 10 | OK |  | 904 |
| mojeek | 10 | OK |  | 594 |
| lobsters | 6 | OK |  | 642 |
| openalex | 5 | OK |  | 625 |
| google | 0 | EMPTY_BLOCK | CAPTCHA | 779 |
| open_library | 0 | EMPTY | empty | 884 |
| semantic_scholar | 0 | EMPTY_NO_CONTAINER | no DOM container | 3140 |
| stack_exchange | 0 | EMPTY | empty | 277 |

## Pool URL Listing (oracle pool — 40 URLs, sorted by URL)
...
17. https://explain.technical.li/postgres-indexes-beyond-b-tree/
...
18. https://habr.com/en/companies/postgrespro/articles/448746/
...
23. https://medium.com/postgres-professional/indexes-in-postgresql-5-gist-86e19781b5db
...
26. https://postgrespro.com/blog/pgsql/4175817
   Title: postgrespro.com/blog/pgsql/4175817
   Snippet: 

27. https://postgrespro.com/docs/postgresql/14/indexes-types
...
28. https://stackoverflow.com/questions/12738997/postgres-gist-vs-btree-index
...
29. https://stackoverflow.com/questions/1540374/why-are-postgresql-text-search-gist-indexes-so-much-slower-than-gin-indexes
...
30. https://stackoverflow.com/questions/21830/postgresql-gin-or-gist-indexes
...
32. https://stackoverflow.com/questions/766488/whats-the-difference-between-b-tree-and-gist-index-methods-in-postgresql
...
33. https://www.2ndquadrant.com/en/blog/parallelism-comes-to-vacuum/
   Title: Parallelism comes to VACUUM
   Snippet: 2ndquadrant.com

34. https://www.elysiate.com/blog/when-to-use-btree-vs-gin-vs-gist-in-postgresql
...
36. https://www.percona.com/blog/2019/06/21/hypothetical-indexes-in-postgresql/
...
38. https://www.postgresql.org/docs/current/gin.html
