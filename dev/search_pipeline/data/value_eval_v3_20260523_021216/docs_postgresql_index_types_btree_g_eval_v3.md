# Value Eval v3 — docs × postgresql index types btree gin gist performance

**Mode:** docs  **Query:** postgresql index types btree gin gist performance  **Pool (filtered):** 40
...
| M4 BM25 vanilla | 3 |
| M5 BM25-Capped | 1 |
| M6 C3 Cross-Encoder | 1379 |
| M7 C3+InstrPrefix | 1445 |
| M8 RRF+C3 Hybrid | 0 |
| M9 SPLADE | 1271 |
| M10 SPLADE+C3 | 0 |
| M11 C3→LLM-Filter | 7578 |
| M12 LLM-Selector | 8744 |
...
4. https://devcenter.heroku.com/articles/postgresql-indexes
   ...
   Efficient Use of PostgreSQL IndexesHeroku Dev Centerhttps://devcenter.heroku.com › articles › postgresql-ind...Heroku Dev Centerhttps://devcenter.heroku.com › articles › postgresql-ind...23 Apr 2026 —
...
6. https://docs.djangoproject.com/en/6.0/ref/contrib/postgres/indexes/
   ...
   PostgreSQL specific model indexesDjango documentationhttps://docs.djangoproject.com › ref › contrib › postgresDjango documentationhttps://docs.djangoproject.com › ref › contrib › postgresTo use this i
...
20. https://explain.technical.li/postgres-indexes-beyond-b-tree/
   Postgres Indexes Beyond B-Tree—GIN, GiST, BRIN, SP-GiST
   Master PostgreSQL's advanced indexes: GIN, GiST, BRIN, SP-GiST with real queries. Boost performance 20-1000x vs B-tree. Practical examples included.
...
25. https://medium.com/@andreyalth/understanding-index-methods-b-tree-hash-gin-gist-sp-gist-brin-postgressql-4f3ddfc263a3
   Understanding index methods — B-Tree — Hash — GIN — GiST - Medium
   The sp-gist index is used to complex data like 2 dimentional data o multidimentional data, the main difference between sp-gist and gist is tha sp-gist split the data in no-overlapping space.

26. https://medium.com/postgres-professional/indexes-in-postgresql-5-gist-86e19781b5db
   Indexes in PostgreSQL — 5 (GiST). In the previous articles,
   Thanks to extensibility, a totally new method can be created from scratch in PostgreSQL: to this end, an interface with the indexing engine must be ...

27. https://neon.com/postgresql/indexes
   PostgreSQL Indexes
   PostgreSQL IndexesNeonhttps://neon.com › postgresql › indexesNeonhttps://neon.com › postgresql › indexesIn this tutorial, you will learn how to use PostgreSQL indexes to enhance the data retrieval spe
...
37. https://stackoverflow.com/questions/766488/whats-the-difference-between-b-tree-and-gist-index-methods-in-postgresql
   ...
   GiST are somewhat different beasts - it's ... GiST indexes are lossy because each document is represented in the index by a fixed- length signature.

38. https://thoughtbot.com/blog/postgres-index-types
   Postgres Index Types
   Postgres Index TypesThoughtbothttps://thoughtbot.com › blog › postgres-index-typesThoughtbothttps://thoughtbot.com › blog › postgres-index-types10 Jan 2025 — B-Tree. The B-Tree index type uses a balan
...
40. https://www.citusdata.com/blog/2017/10/17/tour-of-postgres-index-types/
   ...
   A tour of Postgres Index TypesCitus Datahttps://www.citusdata.com › blog › 2017/10/17 › tour-...Citus Datahttps://www.citusdata.com › blog › 2017/10/17 › tour-...17 Oct 2017 — In Postgres, a B-Tree in

41. https://www.elysiate.com/blog/when-to-use-btree-vs-gin-vs-gist-in-postgresql
   When to Use B-tree vs GIN vs GiST in PostgreSQL | Elysiate
   Learn when to use B-tree, GIN and GiST indexes in PostgreSQL, how they differ and which index type fits equality, range, full-text, JSONB. With examples and tradeoffs.
...
45. https://www.postgresql.org/docs/current/gin.html
   PostgreSQL: Documentation: 18: 65.4. GIN Indexes
   One advantage of GIN is that it allows the development of custom data types with the appropriate access methods, by an expert in the domain of the ...
...
56. https://www.thenile.dev/docs/postgres/indexes
   Indexes in Postgres - Nile Documentation
   Indexes in Postgres - Nile DocumentationNile Postgreshttps://www.thenile.dev › docs › postgres › indexesNile Postgreshttps://www.thenile.dev › docs › postgres › indexesGiST Index. GiST indexes are a v

57. https://www.tigerdata.com/learn/postgresql-performance-tuning-optimizing-database-indexes
   PostgreSQL Performance Tuning - Database Indexes
   PostgreSQL Performance Tuning - Database IndexesTiger Datahttps://www.tigerdata.com › learn › postgresql-performa...Tiger Datahttps://www.tigerdata.com › learn › postgresql-performa...6 Mar 2024 — Thi
